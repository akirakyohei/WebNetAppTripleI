...
namespace ProjectOp.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder builder)
        {
            ...
            {
                builder.UseSqlServer("Server=tcp:triple.database.windows.net,1433;Initial Catalog=coreDB;Persist Security Info=False;User ID=Dong;Password=BDanh1604;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
);
            }
        }
